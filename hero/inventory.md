...
Alguns efeitos e mecânicas podem determinar que uma carta do [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) seja revelada ou permaneça revelada, neste caso, o jogador deve mantê-la visível para todos os jogadores. Sendo permitido aos outros jogadores pegar as cartas do Herói a qualquer momento para ler e fazer verificações.
...
Qualquer carta de Recurso pode ser colocada em um espaço de [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md), não tendo requerimentos de nível de [<span class="knowledge"><b>CONHECIMENTO</b></span>](/hero/knowledge.md) ou outras condições.

---

## Ativação

Cartas ocultas no [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) não podem ser ativadas e devem ter seus efeitos e bônus ignorados a todo momento.
