...
||| <span class="attr "> CONSTITUIÇÃO<span class="bar"> | </span> <span class="short">CON</span></span>  <span style="width: 20px; display: inline-block;"></span> [!badge variant="secondary" text="completude"]
...
||| <span class="attr combat"> FORÇA<span class="bar"> | </span> <span class="short">FOR</span></span>
...
* <b>DANO</b> do Ataque Normal.
* <b>DANO</b> de ataques corpo-a-corpo como espadas, machados, martelos, entre outros.

|||

||| <span class="attr combat"> AGILIDADE<span class="bar"> | </span> <span class="short">AGI</span></span>
...
* Número de pontos de [<span class="main"><b>AÇÃO</b></span>](/hero/#ação) por turno.
...
||| <span class="attr ability"> PERCEPÇÃO<span class="bar"> | </span> <span class="short">PER</span></span>
...
* <b>DANO</b> de ataques a distância, como arco e flecha, armas de fogo, entre outros.
* Ordem de turno dos personagens.

|||

||| <span class="attr ability"> INTELIGÊNCIA<span class="bar"> | </span> <span class="short">INT</span></span>
...
||| <span class="attr magic"> CARISMA<span class="bar"> | </span> <span class="short">CAR</span></span>
...
||| <span class="attr magic"> ESPIRITUAL<span class="bar"> | </span> <span class="short">ESP</span></span>
...
* <b>DANO</b> de ataques etéreos, como magias e encantamentos.
