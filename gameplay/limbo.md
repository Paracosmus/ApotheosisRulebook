...
Enquanto estiver no Limbo, o componente não pode alcançado por ações, bem como não pode interagir com outros componentes ou ser afetado por habilidades ou efeitos.
...
Se a carta resgatada do Limbo não puder retornar para a zona onde estava, ela retorna para o [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) do dono. Caso não tenha dono, ela retornar para a pilha de descarte.
