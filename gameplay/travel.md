...
Cada período do dia durante uma viagem, cada personagem deve descartar uma carta de recurso (suprimento), ou sofrer um dano de 25 de [<span class="main"><b>VIDA</b></span>](/hero/#vida) (+dano adicional em desertos, montanhas, gelo, etc.).
...
:   - Avance para o próximo período do dia.
    - A carta do topo do <span class="event"><b>SANTUÁRIO</b></span> é ativada se possível. O efeito da carta é aplicado a todos os personagens do grupo e deve ser resolvido. Se pelo efeito da carta, ele for enviada para um personagem ao invés de ser descartada, apenas um personagem é escolhido para receber a carta.
...
:   - Avance para o próximo período do dia.
    - A carta do topo do <span class="event"><b>SANTUÁRIO</b></span> é ativada se possível. O efeito da carta é aplicado a todos os personagens do grupo e deve ser resolvido antes de continuar a viagem.
...
E também, determinar o que acontece no momento em que uma carta do topo do <span class="event"><b>SANTUÁRIO</b></span> é ativada pela viagem, modificando esta mecânica, por outra específica.
!!!
