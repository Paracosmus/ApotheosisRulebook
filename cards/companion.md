...
A carta de [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) pode ser de 3 tipos diferentes, que são representados por ícones. O tipo da carta é importante para determinar como ela interage com outras cartas e mecânicas do jogo.
...
#### Evocar
A carta de evocação permanece oculta até que seja evocada e não possui peça no tabuleiro. Para ser evocada, é necessário que o evocador (Herói) selecione uma casa adjacente vazia, e pague 2 de [<span class="skill"><b>MANA</b></span>](/hero/#mana).
...
- Reviver e curar não funciona em automaton, mas sim **Reparar**. Que são feitos por efeito de carta ou mecânica de jogo
  - *Reparar*: Descarte ícones de mech para reparar 25 de [<span class="hp"><b>VIDA</b></span>](/hero/#vida) por ícone descartado. Sendo que isso vale mesmo quando mortos, podendo recuperar vida e até voltarem a vida se for o caso.
...
Quando no turno de um vigilante, pode ser jogado com qualquer outro vigilante, porém usa-se os [<span class="main"><b>AÇÃO</b></span>](/hero/#ação) do personagem do turno.
...
Um [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) pode ou não pertencer a um caminho, que é uma linha de evolução. O caminho é representado por um ícone de uma peça de dominó, que é o mesmo para todas as cartas daquele caminho.

Os 20 caminhos são:

| Caminho | [<span class="companion"><b>HUMANO</b></span>](/cards/companion.md#-humano)                                        | [<span class="companion"><b>CRIATURA</b></span>](/cards/companion.md#-criatura) e [<span class="companion"><b>EVOCAÇÃO</b></span>](/cards/companion.md#-evocação) | {.compact}
| ---     | ---                                                | ---                           |
...
| <span style="color: #AAA"></span> | <span style="color: #AAA">_Usado apenas por casos especiais, como summus._ | |
...
- Se o personagem for uma [<span class="companion"><b>EVOCAÇÃO</b></span>](/cards/companion.md#-evocação), coloque sua peça em uma casa adjacente ao Herói. Se não houver nenhuma casa adjacente disponível, este personagem não pode ser evocado.
...
- Se o personagem for uma [<span class="companion"><b>EVOCAÇÃO</b></span>](/cards/companion.md#-evocação), remova sua peça do tabuleiro.
...
Um [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) pode ter até 5 cartas anexadas a ele. Esse limite não pode ser excedido, nem mesmo por efeito de carta.

Durante o turno do Herói, ele pode anexar e/ou desanexar cartas do seu [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) a um de seus [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) em uma casa adjacente.
...
- Custo de **2** de [<span class="main"><b>AÇÃO</b></span>](/hero/#ação)
- O personagem deve estar em uma casa adjacente ao herói no tabuleiro.

### Tipos de Anexo

Os tipos de anexos marcam características desejadas de cartas anexadas àquele [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md). As cartas anexadas não precisam ter esta característica, mas se tiverem, desbloqueiam técnicas em sua carta.
...
Cartas de [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) são tratadas como personagens, e portanto, possuem uma peça no tabuleiro, podem ser atacados, mortos, realizar testes, etc.. tal qual um Herói.
...
Observando que COMPANHEIROS não possuem MESA nem [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md), quando um texto especificar uma ação impossível para um COMPANHEIRO, como “descarte do seu [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md)” ou “deite 2 de [<span class="skill"><b>MANA</b></span>](/hero/#mana)”, o personagem não tem como cumprir aquela exigência, logo, ela deve ser ignorada.

Porém, quando o texto não apresenta uma restrição, por exemplo, “descarte uma carta” ou “descarte pontos de [<span class="event"><b>DESTINO</b></span>](/cards/event.md)”, o COMPANHEIRO pode/deve utilizar seus anexos nestes casos. Note que se o custo for obrigatório, o personagem precisa pagar, se for opcional o jogador pode optar.

A mesma consideração deve ser feita quando uma carta é obtida pelo COMPANHEIRO, se o texto disser algo como “enviado para o [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md)”, o COMPANHEIRO não tem como realizar esta ação, mas se o texto apenas diz que a carta é “obtida”, ela pode/deve ser anexada ao companheiro, ainda respeitando o limite de anexos.
...
| Nível  | Vida           | {.compact}
| ---    | ---            |
| 1      | <span class="positive"> 5</span>  |
| 2      | <span class="positive"> 10</span> |
| 3      | <span class="positive"> 15</span> |
...
Se o Herói morrer, o jogador deve continuar a batalha utilizando as peças de [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) do tipo [<span class="companion"><b>HUMANO</b></span>](/cards/companion.md#-humano) e/ou [<span class="companion"><b>CRIATURA</b></span>](/cards/companion.md#-criatura) que lhe restam no tabuleiro, ignorando quaisquer efeitos dados pelo Herói. Se o Herói possuir [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) do tipo [<span class="companion"><b>EVOCAÇÃO</b></span>](/cards/companion.md#-evocação), eles são desevocados imediatamente.
