...
Ao custo de 2 de [<span class="main"><b>AÇÃO</b></span>](/hero/#ação), esta carta pode ser enviada para um espaço disponível no [<span class="item"><b>EQUIPAMENTO</b></span>](/hero/table/equipment.md) do Herói.

---

## <span class="item">Desequipar</span>

Ao custo de 2 de [<span class="main"><b>AÇÃO</b></span>](/hero/#ação), esta carta pode ser enviada do [<span class="item"><b>EQUIPAMENTO</b></span>](/hero/table/equipment.md) para o [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) do Herói.
...
Alguns [<span class="item"><b>ITEM</b></span>](/cards/item.md) podem possuir especificadores, que são ícones que definem um tipo de objeto. O Herói pode ter apenas uma carta de cada especificador equipado por vez.
