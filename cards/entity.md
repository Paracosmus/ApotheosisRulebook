...
As cartas de [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) aplicam transformações no personagem, alterando seus atributos e habilidades, o que as tornam uma vantagem estratégica.

O personagem (receptáculo) pode incorporar, estas formas de energia e dominá-las. Cada corpo humano pode abrigar apenas um [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) por vez. Ele se mantém adormecido (carta oculta) e pode ser despertado (carta revelada) a qualquer momento, pelo receptáculo. Quando despertado, o corpo do receptáculo é transformado pelo [<span class="entity"><b>ENTE</b></span>](/cards/entity.md).

||| :icon-file-moved:
![](/static/img/cards/entity.png)
||| :icon-arrow-down-right:
1. **Bônus de Atributo**: Valores adicionados aos [Atributos](/hero/attributes.md) do personagem quando este [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) está desperto.

1. **Tipo**: Ícone e nome do tipo deste [<span class="entity"><b>ENTE</b></span>](/cards/entity.md), definido pelo nível da carta

1. **Nível da Carta**: Equivalente ao seu tipo. Pode ser [<span class="entity"><b>ESPÍRITO</b></span>](/cards/entity.md)➜1, [<span class="entity"><b>DEIDADE</b></span>](/cards/entity.md)➜2 ou [<span class="entity"><b>DEUS</b></span>](/cards/entity.md)➜3

1. **Efeito**: Texto do efeito desta carta, disponível apenas quando o [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) está desperto
|||

| Nível                            | [<span class="entity"><b>ESPÍRITO</b></span>](/cards/entity.md) | [<span class="entity"><b>DEIDADE</b></span>](/cards/entity.md) | [<span class="entity"><b>DEUS</b></span>](/cards/entity.md) | {.compact}
| ---                              | ---          | ---         | ---       |
...
---          | ---   | ---
[<span class="entity"><b>ESPÍRITO</b></span>](/cards/entity.md) | 1     | 3
[<span class="entity"><b>DEIDADE</b></span>](/cards/entity.md)  | 2     | 6
[<span class="entity"><b>DEUS</b></span>](/cards/entity.md)    | 3     | 9
...
O [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) não pode ser adormecido no mesmo turno em que ele foi despertado, a não ser por efeito de carta.
...
O jogador pode adormecer seu [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) a qualquer momento de seu turno. Para isso, basta ocultar a carta de [<span class="entity"><b>ENTE</b></span>](/cards/entity.md).

O [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) não pode ser despertado no mesmo turno em que ele foi adormecido, a não ser por efeito de carta.
...
Os [<span class="entity"><b>ESPÍRITO</b></span>](/cards/entity.md) são inspirados em seres espirituais e espíritos da natureza, como fadas, duendes, elementais, etc. Eles são os entes mais comuns e fáceis de encontrar, mas também os menos poderosos.

As [<span class="entity"><b>DEIDADE</b></span>](/cards/entity.md) são inspirados em divindades menores, como deuses locais, deuses da natureza, deuses olímpicos, etc. Eles são mais raros e poderosos que os [<span class="entity"><b>ESPÍRITO</b></span>](/cards/entity.md), mas também mais difíceis de encontrar. Os deuses dos diferentes panteões mitológicos, como grego, romano, nórdico, egípcio, etc., são exemplos de [<span class="entity"><b>DEIDADE</b></span>](/cards/entity.md).

Os [<span class="entity"><b>DEUS</b></span>](/cards/entity.md) são inspirados nos Aeons do gnosticismo, que são seres divinos e eternos, que emanam a luz e a sabedoria do Deus supremo. Eles são os entes mais raros e poderosos, mas também os mais difíceis de encontrar. Eles são divididos narrativamente em dois grupos, os deuses primordiais, que são os primeiros seres criados, praticamente tão antigos quando o próprio conceito de existência, ligados à criação do universo e à origem da vida. E os deuses sucessores que são os deuses que surgiram depois, ligados a eventos específicos ou ações. Os deuses primordiais são exemplos de [<span class="entity"><b>DEUS</b></span>](/cards/entity.md) de grande apoteose, enquanto os deuses sucessores são exemplos de [<span class="entity"><b>DEUS</b></span>](/cards/entity.md) de pequena apoteose.
