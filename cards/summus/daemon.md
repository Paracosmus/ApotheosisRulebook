...
Daemons são cartas de [<span class="companion"><b>COMPANHEIRO</b></span>](/cards/companion.md) do tipo evocação que ficam de face para baixo no Suporte, quando ativadas elas trazem criaturas de tamanhos variados que por suas dimensões ou condições extra espaciais dimensionais, não possuem uma peça no tabuleiro, mas sim uma área de presença dimensional ou física.
