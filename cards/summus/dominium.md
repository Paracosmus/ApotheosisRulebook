...
- Para ativar um Dominium do seu [<span class="main"><b>INVENTÁRIO</b></span>](/hero/inventory.md) o Herói deve consumir **10** de **Energia** e então enviar a carta para o [<span class="event"><b>CENÁRIO</b></span>](/gameplay/scenario.md).
    - Apenas um Dominium pode estar ativo por vez, portando não é possível ativar um Dominium se já houver outro no [<span class="event"><b>CENÁRIO</b></span>](/gameplay/scenario.md).
- Enquanto estiver no [<span class="event"><b>CENÁRIO</b></span>](/gameplay/scenario.md) os bônus e efeitos da carta são aplicados a todos os personagens no tabuleiro.
