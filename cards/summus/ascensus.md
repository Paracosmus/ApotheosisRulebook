...
- A carta de _Ascensus_ é colocada na **Zona Extra** do Herói.
- A primeira linha da caixa de mecânica indica uma condição que o [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) do Herói deve cumprir para que o bônus seja aplicado. O bônus é aplicado apenas enquanto o [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) do Herói cumprir a condição listada.
- A caixa de mecânica do _Ascensus_ possuí 3 colunas com valores relacionados. O jogador deve calcular o valor de cada coluna e somar os 3 resultados. Esse valor é então aplicado como bônus em cada Atributo do Herói.

||| Caixa de Mecânica
![](/static/img/summus/ascensus.png)

- <span class="summus"></span>: Condição que o [<span class="entity"><b>ENTE</b></span>](/cards/entity.md) do Herói deve cumprir para que o bônus seja aplicado
...
==- <span class="briefing">:icon-feed-issue-closed:</span>ㅤRequerimentos
...
==- <span class="negative">:icon-feed-issue-reopen:</span>ㅤRemover
